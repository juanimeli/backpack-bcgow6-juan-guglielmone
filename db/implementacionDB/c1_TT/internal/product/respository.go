...
type Respository interface {
	Store(ctx context.Context, name, productType string, count int, price float64) (int, error)
...
func (r *repository) Store(ctx context.Context, name, productType string, count int, price float64) (int, error) {
	...
	result, err := stm.Exec(name, productType, count, price)
